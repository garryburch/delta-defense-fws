...
const Home: NextPage = () => {
  ...
  const timelineHeight = () => {  // Arrow function to find height of various elements for timeline cards
    ...
    if (secondCard != null && cardsLine != null) {
      ...
      cardsLine.style.top = (offsetHeight / 2) + 'px'
    }

    if (lastCard != null && cardsLine != null) {
      const offsetHeight = lastCard.offsetHeight
      cardsLine.style.bottom = (offsetHeight / 2) + 'px'
    }
  }
  ...
  useEffect(() => {
    ...
    window.addEventListener('resize', timelineHeight) // EventListener for window resize
    return () => { window.removeEventListener('resize', timelineHeight) }
  ...
  return (
    <>
      <Head>
        <title>Delta Denfense Test</title>
        <meta name="description" content="Generated by Delta Denfense test app" />
